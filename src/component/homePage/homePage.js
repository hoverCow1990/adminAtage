...
class HomePage extends Component{
		...
		return(
			<article className="homePage baseWrapper">
				...
				<section className="user-project">
					...
					<Pagination defaultCurrent={isOther?1:this.props.currentPagination+1} defaultPageSize={3} total={project.length} onChange={(page)=>this.handleCurrentPagination(page)}/>
					</div>
				</section>
	...
	getProject(project){
		let stNum = this.props.currentPagination*3,
			enNum = stNum + 3,
